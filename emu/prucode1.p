...
mov r0, BUF_ADDR
SUB      r0.b0, r0.b0, 4
AND      r0.b0, r0.b0, (DMA_SIZE*2-1)
LBCO     WORD2, CONST_PRURAM, r0, 4 
MOV      r2, 0x80808080 
QBEQ     read_next_word, r2, WORD2
   LBBO     r1, CYCLE_CNTR, 0, 4   // get time
   HALT  // Not magic word
#endif
...
convert_track_time:
   ...
   LSR      r4, r27, 5
      // Convert back to bytes for check
   LSL      r4, r4, 2
      // If more words than in data wrap
   QBLT     convert_ret, TRACK_BYTES, r4        
   SUB      r4, r4, TRACK_BYTES
convert_ret:
      // And back to words
   LSR      r4, r4, 2
   RET
